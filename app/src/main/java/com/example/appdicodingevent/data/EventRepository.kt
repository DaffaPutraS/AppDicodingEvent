package com.example.appdicodingevent.data
...
import com.example.appdicodingevent.data.remote.retrofit.ApiService
...
class EventRepository private constructor(
    ...
    fun getUpcoming5data() : LiveData<Result<List<ListEventsItem>>> = liveData {
        emit(Result.Loading)
        try {
    ...
    fun getFinished5data() : LiveData<Result<List<ListEventsItem>>> = liveData {
        emit(Result.Loading)
        try {
